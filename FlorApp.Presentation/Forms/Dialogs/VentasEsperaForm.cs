...

{
    public partial class VentasEsperaForm : Form
    {
        ...
        public Helpers.VentaEnEspera VentaSeleccionada { get; private set; }

        // Lista interna que almacena las ventas en espera que se mostrarán
        private readonly List<Helpers.VentaEnEspera> _ventas;

        // Constructor que recibe la lista de ventas en espera
        public VentasEsperaForm(List<Helpers.VentaEnEspera> ventasEnEspera)
        {
            InitializeComponent();
